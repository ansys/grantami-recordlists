  ...
  .. tab-item:: Miscellaneous
    ...
    .. list-table::
        ...
        * - Prepare 2.1.1 release
          - `#585 <https://github.com/ansys/grantami-recordlists/pull/585>`_
  ...
  .. tab-item:: Documentation
    ...
    .. list-table::
        ...
        * - Update documentation to refer to 2026 R1 help
          - `#582 <https://github.com/ansys/grantami-recordlists/pull/582>`_


`2.1.0 <https://github.com/ansys/grantami-recordlists/releases/tag/v2.1.0>`_ - March 05, 2026
=============================================================================================
  ...
  .. tab-item:: Added
    ...
    .. list-table::
        ...
        * - Add validation for UUID inputs
          - `#552 <https://github.com/ansys/grantami-recordlists/pull/552>`_
  ...
  .. tab-item:: Dependencies
    ...
    .. list-table::
        ...
        * - Bump nbconvert to v7.17.0
          - `#553 <https://github.com/ansys/grantami-recordlists/pull/553>`_
  ...
  .. tab-item:: Miscellaneous
    ...
    .. list-table::
        ...
        * - Revert 2.1.0rc0 changelog
          - `#549 <https://github.com/ansys/grantami-recordlists/pull/549>`_

        * - Replace development VM with 2026 R1 VM
          - `#550 <https://github.com/ansys/grantami-recordlists/pull/550>`_

        * - Prepare 2.1.0rc1 release
          - `#574 <https://github.com/ansys/grantami-recordlists/pull/574>`_

        * - Prepare 2.1.0 release
          - `#577 <https://github.com/ansys/grantami-recordlists/pull/577>`_
  ...
  .. tab-item:: Documentation
    ...
    .. list-table::
        ...
        * - Fix changelog fragments
          - `#570 <https://github.com/ansys/grantami-recordlists/pull/570>`_
  ...
  .. tab-item:: Maintenance
    ...
    .. list-table::
        ...
        * - Update missing or outdated files
          - `#512 <https://github.com/ansys/grantami-recordlists/pull/512>`_, `#568 <https://github.com/ansys/grantami-recordlists/pull/568>`_
        ...
        * - Switch to uv for package management and CI
          - `#544 <https://github.com/ansys/grantami-recordlists/pull/544>`_

        * - Restore UV packages in frozen mode
          - `#548 <https://github.com/ansys/grantami-recordlists/pull/548>`_

        * - Configure dependabot to use uv
          - `#554 <https://github.com/ansys/grantami-recordlists/pull/554>`_

        * - Disable fail fast from integration tests
          - `#563 <https://github.com/ansys/grantami-recordlists/pull/563>`_
