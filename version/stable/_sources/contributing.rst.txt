...
Run the following commands to clone and install the latest version of PyGranta RecordLists
...
Post issues
===========
Use the `PyGranta RecordLists Issues <https://github.com/pyansys/grantami-recordlists/issues>`_ page
